const APP = {
        ...
        const toolsData = [
            ...
            { id: 'merge', cat: 'organize', icon: 'fa-layer-group', color: 'purple', accept: 'application/pdf,.pdf', multi: true, actionBtn: 'btnActionMerge',
              ar: { t: 'دمج PDF', d: 'اجمع عدة ملفات PDF في مستند واحد بسهولة، مع الحفاظ على ترتيب الملفات قبل التصدير.' }, en: { t: 'Merge PDF', d: 'Combine multiple files into one' } },
            { id: 'split', cat: 'organize', icon: 'fa-scissors', color: 'purple', accept: 'application/pdf,.pdf', multi: false, actionBtn: 'btnActionExecute',
              ar: { t: 'تقسيم PDF', d: 'استخرج صفحات محددة أو نطاقات من ملف PDF واحفظها في ملف جديد.' }, en: { t: 'Split PDF', d: 'Extract pages or ranges' } },
            { id: 'delete', cat: 'organize', icon: 'fa-trash-can', color: 'purple', accept: 'application/pdf,.pdf', multi: false, actionBtn: 'btnActionExecute',
              ar: { t: 'حذف صفحات', d: 'احذف الصفحات غير المطلوبة من ملف PDF بسرعة واختر الصفحات التي تريد الاحتفاظ بها.' }, en: { t: 'Delete Pages', d: 'Select and remove pages' } },
            { id: 'reorder', cat: 'organize', icon: 'fa-sort', color: 'purple', accept: 'application/pdf,.pdf', multi: false, actionBtn: 'btnActionExecute',
              ar: { t: 'إعادة ترتيب الصفحات', d: 'غيّر ترتيب صفحات PDF بسهولة لتنظيم المستند قبل الحفظ.' }, en: { t: 'Reorder Pages', d: 'Set a new page order' } },
            { id: 'compress', cat: 'optimize', icon: 'fa-compress', color: 'blue', accept: 'application/pdf,.pdf', multi: false, actionBtn: 'btnActionExecute',
              ar: { t: 'ضغط PDF', d: 'حاول تقليل حجم ملف PDF عبر إعادة بنائه بطريقة مناسبة للمشاركة والتخزين.' }, en: { t: 'Compress PDF', d: 'Re-save PDF to optimize size' } },
            { id: 'images', cat: 'toPDF', icon: 'fa-image', color: 'green', accept: 'image/jpeg,image/png,image/webp,image/*,.jpg,.jpeg,.png,.webp', multi: true, actionBtn: 'btnActionConvert', type: 'img',
              ar: { t: 'صور إلى PDF', d: 'حوّل صور JPG وPNG وWebP إلى ملف PDF واحد، مع دعم عدة صور.' }, en: { t: 'Images to PDF', d: 'JPG, PNG and WebP to PDF' } },
            { id: 'word', cat: 'fromPDF', icon: 'fa-file-word', color: 'blue', accept: 'application/pdf,.pdf', multi: false, actionBtn: 'btnActionConvert',
              ar: { t: 'PDF إلى Word', d: 'حوّل محتوى PDF النصي إلى ملف Word بصيغة DOCX عندما يكون النص قابلاً للاستخراج.' }, en: { t: 'PDF to Word', d: 'Extract text to DOCX' } },
            { id: 'excel', cat: 'toPDF', icon: 'fa-file-excel', color: 'green', accept: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel,.xlsx,.xls', multi: true, actionBtn: 'btnActionConvert', type: 'excel',
              ar: { t: 'Excel إلى PDF', d: 'حوّل ملفات Excel وأوراق العمل إلى PDF لسهولة المشاركة والطباعة.' }, en: { t: 'Excel to PDF', d: 'Convert Excel sheets to PDF' } },
            { id: 'ppt', cat: 'fromPDF', icon: 'fa-file-powerpoint', color: 'orange', accept: 'application/pdf,.pdf', multi: false, actionBtn: 'btnActionConvert',
              ar: { t: 'PDF إلى PPT', d: 'حوّل صفحات PDF إلى شرائح PowerPoint قابلة للعرض والتحرير.' }, en: { t: 'PDF to PPT', d: 'Each page becomes a slide' } },
            { id: 'protect', cat: 'security', icon: 'fa-lock', color: 'red', accept: 'application/pdf,.pdf', multi: false, actionBtn: 'btnActionProtect',
              ar: { t: 'حماية PDF', d: 'احمِ ملف PDF بكلمة مرور للمساعدة في منع الوصول غير المصرح به.' }, en: { t: 'Protect PDF', d: 'Encrypt PDF with a password' } },
            { id: 'unlock', cat: 'security', icon: 'fa-unlock', color: 'red', accept: 'application/pdf,.pdf', multi: false, actionBtn: 'btnActionExecute',
              ar: { t: 'فك حماية PDF', d: 'افتح ملف PDF المحمي باستخدام كلمة المرور الصحيحة التي تملكها.' }, en: { t: 'Unlock PDF', d: 'Unlock with known password' } },
            { id: 'numbers', cat: 'organize', icon: 'fa-hashtag', color: 'yellow', accept: 'application/pdf,.pdf', multi: false, actionBtn: 'btnActionExecute',
              ar: { t: 'أرقام الصفحات', d: 'أضف أرقام الصفحات إلى مستند PDF لتنظيمه وتسهيل الرجوع إلى صفحاته.' }, en: { t: 'Page Numbers', d: 'Add page numbers' } }
        ];
